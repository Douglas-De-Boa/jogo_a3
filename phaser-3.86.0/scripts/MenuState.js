class MenuState extends Phaser.Scene {
    ...
    preload() {
        this.load.image('bg', '/phaser-3.86.0/src/img/conteudo/Background/back1.png');
        this.load.image('playButton', '/phaser-3.86.0/src/img/conteudo/BOTÃO/BOTÃO_PLAY.png');
    }
    ...
    create() {
        ...
        const playButton = this.add.image(470, 400, 'playButton').setInteractive();
